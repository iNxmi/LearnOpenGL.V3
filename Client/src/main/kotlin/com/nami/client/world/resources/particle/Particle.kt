...
import com.nami.client.easing.EasingFunction
import com.nami.client.easing.JSONEasingExpression
import com.nami.client.json.JSONRange
import com.nami.client.random
import com.nami.client.resources.particle.ParticleColorJSON
import com.nami.client.resources.particle.ResourceParticle
    ...
    data class JSON(
        ...
        fun create(id: String): Particle {
            val handlerClass: Class<*> =
                try {
                    Class.forName("com.nami.client.world.resources.particle.handlers.ParticleHandler${id.snakeToUpperCamelCase()}")
                } catch (e: Exception) {
                    Class.forName("com.nami.client.world.resources.particle.handlers.DefaultParticleHandler")
                }
