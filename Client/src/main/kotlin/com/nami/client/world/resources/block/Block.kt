...
import com.nami.client.resources.Resources.Companion.TEXTURE
import com.nami.client.resources.block.BlockDropJSON
import com.nami.client.resources.block.BlockTextureNamesJSON
import com.nami.client.resources.block.ResourceBlock
    ...
    data class JSON(
        ...
        fun create(id: String): Block {
            ...
            val handlerClass: Class<*> =
                try {
                    Class.forName("com.nami.client.world.resources.block.handlers.BlockHandler${id.snakeToUpperCamelCase()}")
                } catch (e: Exception) {
                    Class.forName("com.nami.client.world.resources.block.handlers.DefaultBlockHandler")
                }
