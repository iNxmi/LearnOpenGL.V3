...
object BlockBirchLeaves : Block(id = "birch_leaves" ){
    ...
    override val textures = mapOf(
        ChunkMesh.Face.TOP to "block.birch_leaves",
        ChunkMesh.Face.BOTTOM to "block.birch_leaves",
        ChunkMesh.Face.NORTH to "block.birch_leaves",
        ChunkMesh.Face.EAST to "block.birch_leaves",
        ChunkMesh.Face.WEST to "block.birch_leaves",
        ChunkMesh.Face.SOUTH to "block.birch_leaves"
    )
