package com.nami.world.item.items

import com.nami.world.item.Item

object ItemLighter : Item("lighter") {

    override val weight = 0.025F

//    override fun onPrimaryUse(world: World, item: com.nami.world.resources.item.Item.Instance, player: Player): Boolean {
//        val random = Random(System.currentTimeMillis())
//        val position = player.getFacingMaterial(world)?.position ?: return false
//
...
//    override fun onSecondaryUse(world: World, item: com.nami.world.resources.item.Item.Instance, player: Player): Boolean {
//        return false
//    }
