...
import com.nami.world.block.BlockBirchLeaves
import com.nami.world.block.BlockBirchLog
...
object FeatureBirchTree : Feature(id = "birch_tree") {
    ...
    override fun generate(
        ...
        for (i in 0 until baseHeight)
            blocks[Vector3i(0, i, 0)] = BlockBirchLog
        ...
        for (i in 0 until 5) {
            ...
            for (j in 5 until 15) {
                ...
                blocks[Vector3i(position)] = BlockBirchLog
                ...
                for (z in -1..1)
                    for (y in -1..1)
                        for (x in -1..1) {
                            ...
                            blocks[Vector3i(pos)] = BlockBirchLeaves
                        }
            }
        }
