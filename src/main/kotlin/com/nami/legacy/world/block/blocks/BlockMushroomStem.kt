...
object BlockMushroomStem : Block(id = "mushroom_stem") {
    ...
    override val textures = mapOf(
        Face.TOP to "block.mushroom_stem",
        Face.BOTTOM to "block.mushroom_stem",
        Face.NORTH to "block.mushroom_stem",
        Face.EAST to "block.mushroom_stem",
        Face.WEST to "block.mushroom_stem",
        Face.SOUTH to "block.mushroom_stem"
    )
